# Generated by Django 5.0.4 on 2024-06-24 18:43
...
def create_unique_brands(apps, schema_editor):
    ...
    uniques_brands_names = shoe.objects.values_list('brand', flat=True).distinct()

    unique_brands.objects.bulk_create([unique_brands(brand_name=brand_name) for brand_name in uniques_brands_names])
