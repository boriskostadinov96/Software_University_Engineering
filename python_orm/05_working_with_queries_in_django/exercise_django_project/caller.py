...
def get_high_difficulty_cardio_workouts():
    return Workout.objects.filter(workout_type=WorkoutTypeChoice.CARDIO, difficulty='High').order_by('instructor')
...
def delete_workouts():
    Workout.objects.exclude(workout_type__in=(WorkoutTypeChoice.CALISTHENICS, WorkoutTypeChoice.STRENGTH)).delete()
