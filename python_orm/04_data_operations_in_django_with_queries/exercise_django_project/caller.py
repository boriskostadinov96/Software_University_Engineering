...
def rename_artifact(artifact: Artifact, new_name: str):
    # Artifact.objects.filter(is_magical=True, age__gt=250, pk=artifact.pk).update(name=new_name) -> other approach
...
def update_characters():
    ...
    Character.objects.filter(class_name=["Assassin", "Scout"]).update(
