...
class TestCar(TestCase):
    ...
    def test_refuel_more_than_capacity_can_fills(self):
        self.car.fuel_capacity = 75
        self.car.refuel(90)
        self.assertEqual(75, self.car.fuel_capacity)

    def test_drive_car_without_fuel_raise_exception(self):
        with self.assertRaises(Exception) as ex:
            self.car.drive(100)

        self.assertEqual("You don't have enough fuel to drive!", str(ex.exception))

    def test_drive_car_with_fuel_raise_exception(self):
